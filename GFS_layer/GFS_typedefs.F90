module GFS_typedefs
       ...
       !--- version of physics
       character(len=64) :: version = 'SHiELD 2019 physics'
  ...
  subroutine control_initialize (Model, nlunit, fn_nml, me, master, &
    ...
    NAMELIST /gfs_physics_nml/                                                              &
                          ...
                          !--- physical parameterizations
                               ...
                               random_clds, shal_cnv, imfshalcnv, imfdeepcnv,               &
                               do_deep, jcap,&
                               cs_parm, flgmin, cgwf, ccwf, cdmbgwd, sup, ctei_rm, crtrh,   &
                               dlqf,rbcr,mix_precip,orogwd,myj_pbl,ysupbl,                  &
